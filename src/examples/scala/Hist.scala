...
import datasets.{MultiColumnDataset, DatasetConverter, DatasetLoader, Dataset}
...
//  val data: MultiColumnDataset[Double] = DatasetConverter.toNumeric(DatasetLoader.loadFromFile("data/test.csv"))
//
//  LoadData.print(data)
//
//  val model = new NormalModel
//  val LRTs = new LikelihoodRatioStatistic[Double, MultiColumnDataset[Double]](model, 10)
//  val BootLRTs = new WeightedLikelihoodRatioStatistic[Double, MultiColumnDataset[Double]](model, 10)
//
